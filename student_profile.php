...
<body>
  ...
  <?php
    ...
    if (isset($_SESSION['student_id'])) {
      include 'get_student_info.php'; // Include code to fetch student information
    } else {
      echo "Error: Student ID not found in session. Please login.";
      echo "<br><a href='student_login_page.php'>Login Page</a>"; // Link to login page
    }
  ?>

    <div class="profile-details">
      <label for="name">Name:</label>
      <span id="name"><?php echo $student_name; ?></span>
    </div>
    <div class="profile-details">
      <label for="registrationno">Registration Number:</label>
      <span id="registrationno"><?php echo $student_registration; ?></span>
    </div>
    <div class="profile-details">
      <label for="degree">Degree:</label>
      <span id="degree"><?php echo $student_degree; ?></span>
    </div>
    <div class="profile-details">
      <label for="department">Department:</label>
      <span id="department"><?php echo $student_department; ?></span>
    </div>
    <div class="profile-details">
      <label for="email">Email:</label>
      <span id="email"><?php echo $student_email; ?></span>
    </div>

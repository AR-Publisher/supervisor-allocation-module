...
mysqli_close($conn);
// Function to retrieve the number of applied students for a supervisor
function getAppliedCount($conn, $supervisor_id) {
  $sql = "SELECT COUNT(*) AS applied_count FROM application WHERE supervisor_id = ?";
